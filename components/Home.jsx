...
//<Img alt="blur" src="/logo.gif" layout="fill" />
export default class Home extends Component {
    ...
    componentDidMount() {
        ...
        var typed = new Typed('#tt', {
            strings: ["Web Designer - JavaScript, React Developer."],
            typeSpeed: 200,
            backDelay: 15,
            loop: false
          });
    ...
    render() {
        return (<div id="app">
            ...
            <div className="box">
                <div className="box-image"><Img width={500} height={283} quality={100} alt="Mert" src="/logo.gif" /></div>
                <h1>M&ecirc;rt</h1>
                <p className="mert-t" id="tt"></p>
                <div className="flex-box">
                    <div><a href="https://netoniro.vercel.app/" target="_blank" title="Mert NetOniro">NetOniro</a>
                        <hr /></div>
                    <div><a href="https://instagram.com/mertcelik2196" target="_blank" title="Mert İnstagram">İnstagram</a>
                        <hr /></div>
                    <div><a href="https://www.youtube.com/channel/UC6MiYSCbkiRC2UonCpwUzBw" target="_blank" title="Mert YouTube">YouTube</a>
                        <hr /></div>
                </div>
            </div>
